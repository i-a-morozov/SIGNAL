...
! gfortran -o example02 -fopenmp -cpp -std=f2018 -Wall -pedantic -O3 -ffast-math -march=native -L. example02.f90 -lsignal  -llapack -lblas -lm -lfftw3 -lgsl -lgslcblas -lgfortran
...
PROGRAM EXAMPLE
  ...
  !$OMP PARALLEL DO
  DO I = 1_IK, LIMIT, 1_IK
    OUTPUT(I) = FREQUENCY_(FLAG, PEAK, LENGTH, TOTAL, WINDOW, DATA(I, :))
  END DO
  !$OMP END PARALLEL DO
